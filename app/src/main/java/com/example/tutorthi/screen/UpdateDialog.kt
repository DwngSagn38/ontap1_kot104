...
fun UpdateSanPham(
    ...
    var inputName by remember {
        mutableStateOf( sp.ph42693_name )
    }

    var inputPrice by remember {
        mutableStateOf(formatCurrency(sp.ph42693_price.toString()))
    }

    var inputModel by remember {
        mutableStateOf(sp.model_ph42693)
    }


    val status = if(sp.status_ph42693 == true) "San pham moi" else "San pham cu"
